...
// EXPANSION IO 0
#define STATUS_MOD_IO0_ON()			HAL_GPIO_WritePin(MOD_IO0_GPIO_Port, MOD_IO0_Pin, GPIO_PIN_SET)
#define STATUS_MOD_IO0_OFF()		HAL_GPIO_WritePin(MOD_IO0_GPIO_Port, MOD_IO0_Pin, GPIO_PIN_RESET)
#define STATUS_MOD_IO0_TOGGLE() 	HAL_GPIO_TogglePin(MOD_IO0_GPIO_Port, MOD_IO0_Pin)

// EXPANSION IO 1
#define STATUS_MOD_IO1_ON()			HAL_GPIO_WritePin(MOD_IO1_GPIO_Port, MOD_IO1_Pin, GPIO_PIN_SET)
#define STATUS_MOD_IO1_OFF()		HAL_GPIO_WritePin(MOD_IO1_GPIO_Port, MOD_IO1_Pin, GPIO_PIN_RESET)
#define STATUS_MOD_IO1_TOGGLE() 	HAL_GPIO_TogglePin(MOD_IO1_GPIO_Port, MOD_IO1_Pin)
